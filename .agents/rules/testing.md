...
- **Never Declare Success Without Running Tests**: After adding or updating code, run `pytest` (or `python -m pytest`) to ensure all unit and integration test suites pass with 100% success rate.
