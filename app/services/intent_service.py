...
class IntentService:
    ...
    def predict_intent(self, raw_query: str) -> Dict[str, Any]:
        ...
        product_triggers = ["ไม่เกิน", "งบ", "บาท", "ขอดู", "อยากได้", "อยากเห็น", "หาเสื้อ", "มีเสื้อ", "ราคาประมาณ", "สักตัว", "ขายดี", "ฮิต", "ยอดฮิต", "best seller", "นิยม", "กระเป๋า", "กางเกง", "ยีนส์", "โปโล", "ครอป", "เบบี้ที"]
