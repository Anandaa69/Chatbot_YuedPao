...
def build_fabric_comparison_flex() -> Dict[str, Any]:
    ...
    """
    fabrics = [
        {"name": "☁️ Ultrasoft (ผ้านุ่มพิเศษ)", "desc": "สัมผัสนุ่มเบาสบาย ซักแล้วไม่ยับ ไม่ต้องรีด คืนทรงสวยงาม"},
        {"name": "❄️ Tailor Cool (ผ้าเย็นระบายอากาศ)", "desc": "เส้นใยพิเศษช่วยระบายความร้อน เหมาะกับสภาพอากาศเมืองไทย ใส่ออกกำลังกายได้ดี"},
        {"name": "🌿 Classic Cotton (ฝ้ายธรรมชาติ 100%)", "desc": "ผ้าฝ้ายเกรดพรีเมียม สัมผัสธรรมชาติ นุ่มซับเหงื่อได้ดีเยี่ยม"},
        {"name": "♻️ Ecotech (เส้นใยเป็นมิตรต่อสิ่งแวดล้อม)", "desc": "ผสมผสานเส้นใยรีไซเคิล ยืดหยุ่นสูง ทนทาน ซักบ่อยสีไม่ซีดจาง"}
    ]
